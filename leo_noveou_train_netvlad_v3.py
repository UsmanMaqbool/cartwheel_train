...
if __name__ == '__main__':
    ...
    LOG_DIR = './models.keras/Jan2020/centeredinput-m1to1-%dx%dx%d__%s-%s__K%d__allpairloss' %(image_nrows, image_ncols, image_nchnl, CNN_type, layer_name, netvlad_num_clusters)
    global int_logr
    int_logr = InteractiveLogger( LOG_DIR )

    #---
    PITS_PATH = '/app/datasets/NetvLad/Pittsburgh/'
    PITS_VAL_PATH = '/app/datasets/NetvLad/Pitssburg_validation/'
